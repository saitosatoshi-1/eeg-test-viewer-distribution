...
from eeg_montage import (
    ...
    decimate_traces_for_display,
    filter_padding_payload,
    is_ecg_channel_name,
...
from research_validation import (
    VALIDATION_DECISION_ADOPT,
    VALIDATION_DECISION_ALIASES,
    VALIDATION_DECISION_EXCLUDE,
    VALIDATION_DECISION_LABELS,
    VALIDATION_DECISIONS,
    active_validation_response_map,
    validation_case_in_set,
    validation_case_rows as filter_validation_case_rows,
    validation_case_rows_for_set as filter_validation_case_rows_for_set,
    validation_set,
...
def research_compact_reader_profile(profile: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        for key in (
            ...
            "medicalPracticeYears", "eegReadingCount", "eegReadingCountUnit",
...
def validation_case_rows(dataset: dict[str, Any]) -> list[dict[str, Any]]:
    return filter_validation_case_rows(research_case_rows(dataset))


def validation_case_rows_for_set(dataset: dict[str, Any], selected: str) -> list[dict[str, Any]]:
    return filter_validation_case_rows_for_set(research_case_rows(dataset), selected)
